...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttendeeListImport.confirmed'
        db.add_column(u'attendee_attendeelistimport', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AttendeeListImport.present'
        db.add_column(u'attendee_attendeelistimport', 'present',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttendeeListImport.confirmed'
        db.delete_column(u'attendee_attendeelistimport', 'confirmed')

        # Deleting field 'AttendeeListImport.present'
        db.delete_column(u'attendee_attendeelistimport', 'present')
    ...
    models = {
        ...
        u'attendee.attendeelistimport': {
            'Meta': {'object_name': 'AttendeeListImport'},
            'confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
